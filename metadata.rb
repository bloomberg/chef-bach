...
depends 'bach_common', '= 2.1.2'
depends 'bach_krb5', '= 2.1.2'
depends 'bach_repository', '= 2.1.2'
depends 'bach_spark', '= 2.1.2'
depends 'bcpc', '= 2.1.2'
depends 'bcpc-hadoop', '= 2.1.2'
depends 'bcpc_jmxtrans', '= 2.1.2'
depends 'hannibal', '= 2.1.2'
depends 'java','>= 1.41.0'
depends 'kafka-bcpc', '= 2.1.2'
