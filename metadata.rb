...
depends 'bach_common', '= 2.3.0'
depends 'bach_krb5', '= 2.3.0'
depends 'bach_repository', '= 2.3.0'
depends 'bach_spark', '= 2.3.0'
depends 'bcpc', '= 2.3.0'
depends 'bcpc-hadoop', '= 2.3.0'
depends 'bcpc_jmxtrans', '= 2.3.0'
depends 'hannibal', '= 2.3.0'
depends 'java','>= 1.41.0'
depends 'bcpc_kafka', '= 2.3.0'
