...
depends 'bach_common', '= 3.0.1'
depends 'bach_krb5', '= 3.0.1'
depends 'bach_repository', '= 3.0.1'
depends 'bach_spark', '= 3.0.1'
depends 'bcpc', '= 3.0.1'
depends 'bcpc-hadoop', '= 3.0.1'
depends 'bcpc_jmxtrans', '= 3.0.1'
depends 'hannibal', '= 3.0.1'
depends 'bcpc_kafka', '= 3.0.1'
