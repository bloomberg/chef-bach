...
depends 'bach_common', '= 2.4.1'
depends 'bach_krb5', '= 2.4.1'
depends 'bach_repository', '= 2.4.1'
depends 'bach_spark', '= 2.4.1'
depends 'bcpc', '= 2.4.1'
depends 'bcpc-hadoop', '= 2.4.1'
depends 'bcpc_jmxtrans', '= 2.4.1'
depends 'hannibal', '= 2.4.1'
depends 'java','>= 1.41.0'
depends 'bcpc_kafka', '= 2.4.1'
