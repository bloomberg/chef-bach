...
module BACH
  ...
  module ClusterData
    ...
    module ChefNode
      ...
      def ridley
        # FIXME: change to be use .chef/knife.rb (default) when databags are
        # being generated by the bootstrap-admin client.
        #
        ...
        @ridley ||= Dir.chdir(repo_dir) { Ridley.from_chef_config('/etc/chef/client.rb', ssl: {verify: false}) }
      end
    end
  end
end
