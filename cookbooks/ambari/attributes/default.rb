...
default['ambari']['platform_major_version'] = \
  "#{node['platform']}#{node['platform_version'].split('.')[0]}"
default['ambari']['ambari_ubuntu_repo_url'] = \
  'http://public-repo-1.hortonworks.com/ambari/' \
  "#{node['ambari']['platform_major_version']}" \
  "/2.x/updates/#{node['ambari']['ambari_server_version']}"
...
default['ambari']['ambari_views_url'] = \
  "#{node['ambari']['ambari_server_base_url']}/api/v1/views"
...
default['ambari']['kerberos']['keytab']['location'] = \
  '/etc/security/keytabs/ambari.service.keytab'

# Ambari internal postgres database attributes
default['ambari']['pg_db_script_path'] = \
  '/var/lib/ambari-server/resources/Ambari-DDL-Postgres-EMBEDDED-CREATE.sql'
default['ambari']['pg_schema_path'] = \
...
default['ambari']['files_path'] = \
  'FILES/versions/1.0.0/instances/FILES_NEW_INSTANCE'
default['ambari']['webhdfs.client.failover.proxy.provider'] = \
...
default['ambari']['hive20_view_path'] = \
  'HIVE/versions/2.0.0/instances/HIVE_NEW_INSTANCE'
...
default['ambari']['wfmanager_view_path'] = \
  'WORKFLOW_MANAGER/versions/1.0.0/instances/WFM_NEW_INSTANCE'
default['ambari']['yarn.resourcemanager.address'] = 'http://localhost:8032'

# Tez views
default['ambari']['tez_view_path'] = \
  'TEZ/versions/0.7.0.2.6.4.0-91/instances/TEZ_NEW_INSTANCE'
...
default['ambari']['authentication']['ldap'].tap do |ldap|
  ...
  ldap['managerPassword'] = \
    File.join(
      ...
      node['ambari']['ldap']['password_file']
    )
  ldap['primaryUrl'] = ''
  ldap['secondaryUrl'] = ''
  ldap['useSSL'] = false
