...
default['bcpc']['hadoop']['hdfs']['user'].tap do |user|
  ...
  user['perms'] = '0700'
  user['space_quota'] = '30G'
  user['ns_quota'] = 'NO_QUOTA'
  user['dirinfo'] = {
...
# Default HDFS Groups Directory Configuration
default['bcpc']['hadoop']['hdfs']['groups'].tap do |groups|
  groups['home'] = '/groups'
  groups['owner'] = 'hdfs'
  groups['perms'] = '0770'
  groups['space_quota'] = '50G'
  groups['ns_quota'] = 'NO_QUOTA'
  groups['dirinfo'] = {
    ## Example dir_info entry:
    # group_dirname: {
    #   owner: 'user',
...
# Default HDFS Projects Directory Configuration
