...
make_bcpc_config('mysql-hive-password', secure_password)

# Hive table stats user
make_bcpc_config('mysql-hive-table-stats-user', node["bcpc"]["hadoop"]["hive"]["hive_table_stats_db_user"])
make_bcpc_config('mysql-hive-table-stats-password', secure_password)
