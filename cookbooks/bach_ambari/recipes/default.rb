...
force_default['ambari']['webhdfs.ha.namenodes.list'] = namenodes
force_default['ambari']['webhdfs.nameservices'] = node.chef_environment
force_default['ambari']['webhdfs.url'] = \
...
if node['ambari']['ldap_password'].nil?
  force_default['ambari']['ldap_password'] = \
    get_config('password', 'ldap', 'os')
end

force_default['ambari']['ambari_server_base_url'] = \
...
force_default['ambari']['hive.jdbc.url'] = hive_jdbc_url
...
force_default['ambari']['yarn.resourcemanager.url'] = resource_manager_url

timeline_server = \
  get_timeline_servers
  .map { |e| "http://#{float_host(e['hostname'])}:#{ts_port}" }.first

force_default['ambari']['yarn.ats.url'] = timeline_server
...
rm_address = node['bcpc']['hadoop']['rm_hosts']
             ...
             .join(',')
default['ambari']['oozie.service.uri'] = "#{oozie_url}/oozie"
default['ambari']['yarn.resourcemanager.address'] = rm_address
