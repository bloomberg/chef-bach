...
node.override['java']['jdk']['8']['x86_64']['url'] = get_binary_server_url + "jdk-8u101-linux-x64.tar.gz"
node.override['java']['jdk']['8']['i586']['url'] = get_binary_server_url + "jdk-8u101-linux-i586.tar.gz"
