...
default['bcpc']['zabbix']['scripts']['mail'] = "/usr/local/bin/zbx_logger.sh"
...
default['bcpc']['zabbix']['chef_client_check_interval'] = (node['chef_client']['interval'].to_i * 3 + node['chef_client']['splay'].to_i) * 2
