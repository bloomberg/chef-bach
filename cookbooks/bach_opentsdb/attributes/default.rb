...
default['bach_opentsdb']['core']['auto_create_metrics'] = 'true'
...
default['bach_opentsdb']['zk_quorum'] = nil

### Service management/JVM parameters
default['bach_opentsdb']['java_home'] = nil
...
### Package attributes
default['bach_opentsdb']['package_version'] = nil
